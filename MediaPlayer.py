        ...
        if "play_btn" in request.form:
            ...
            if click == 0:
                ...
                try:
                   ...
                   os.system("sudo dbus-send --system --print-reply --dest=org.bluez /org/bluez/hci0/dev_D0_D2_B0_0D_1A_8E/player2 org.freedesktop.DBus.Properties.Get string:org.bluez.MediaPlayer1 string:Track")
                   #print("~~~~~~~~~~~~~~~TEST:\n" + str(test))
                except Exception as e:
                    print(str(e))
                return render_template("pause.html")
